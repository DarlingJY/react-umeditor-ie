...
var EditorCore = function (_Component) {
  ...
  _createClass(EditorCore, [{
    ...
    value: function handleToolbarIconClick(e, state) {
      ...
      (state.icon === 'insertorderedlist'||state.icon === 'insertunorderedlist'||state.icon === 'bold'||state.icon === 'italic'||state.icon === 'indent'||state.icon === 'outdent'||state.icon === 'justifyleft'||state.icon === 'justifycenter'||state.icon === 'justifycenter'||state.icon==='strikethrough'||state.icon==='cleardoc'||state.icon==='subscript'||state.icon==='superscript'||state.icon==='date'||state.icon==='time') && _EditorSelection2.default.restoreRange();
      // _EditorSelection2.default.restoreRange();
      switch (state.icon) {
        case "source":
