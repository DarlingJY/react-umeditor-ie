...
var EditorCore = function (_Component) {
  ...
  _createClass(EditorCore, [{
    ...
    value: function handleToolbarIconClick(e, state) {
      ...
      // (state.icon !== 'paragraph'||state.icon !== 'fontfamily'||state.icon !== 'fontsize'||state.icon !== 'fontfamily'||state.icon !== 'forecolor'||state.icon !== 'backcolor'||state.icon !== 'image'||state.icon !== 'spechars'||state.icon !== 'inserttable'||state.icon !== 'custom-link')&& _EditorSelection2.default.restoreRange();
      (state.icon === 'insertorderedlist'||state.icon === 'insertunorderedlist'||state.icon === 'bold'||state.icon === 'italic'||state.icon === 'indent'||state.icon === 'outdent'||state.icon === 'justifyleft'||state.icon === 'justifycenter'||state.icon === 'justifycenter'||state.icon==='strikethrough'||state.icon==='cleardoc') && _EditorSelection2.default.restoreRange();
      // _EditorSelection2.default.restoreRange();
