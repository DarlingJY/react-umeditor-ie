...
var EditorResize = function (_Component) {
  ...
  function EditorResize() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = EditorResize.__proto__ || Object.getPrototypeOf(EditorResize)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      document.onmousemove = function(val){
        _this.handleMouseMove(val)
      }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('div', { className: 'block-resize nw-resize', onMouseDown: this.handleMouseDown, }),
          _react2.default.createElement('div', { className: 'block-resize ne-resize', onMouseDown: this.handleMouseDown, }),
          _react2.default.createElement('div', { className: 'block-resize sw-resize', onMouseDown: this.handleMouseDown, }),
          _react2.default.createElement('div', { className: 'block-resize se-resize', onMouseDown: this.handleMouseDown, })
        )
      );
    }
  }]);
