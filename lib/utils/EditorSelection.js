...
console.log(this.range)
      var parentElement = this.range.startContainer.parentElement||this.range.startContainer.parentNode;
      console.log(parentElement)
			while (parentElement&&((parentElement.tagName || parentElement.nodeName).toUpperCase() != "DIV")) {
